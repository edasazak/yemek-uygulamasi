...
public class SepettekiYemekler implements Serializable {
    ...
    private String kullanici_adi = "eda";

    public SepettekiYemekler() {
    }

    public SepettekiYemekler(int sepet_yemek_id, String yemek_adi, String yemek_resim_adi, int yemek_fiyat, String yemek_siparis_adet, String kullanici_adi) {
